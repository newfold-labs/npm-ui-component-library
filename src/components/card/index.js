...
const Header = ( { as: Component = "div", children, className = "", ...props } ) => (
	<Component { ...props } className={ classNames( "nfd-card__header", className ) }>
		{ children }
	</Component>
);
...
const Content = ( { as: Component = "div", children, className = "", ...props } ) => (
	<Component { ...props } className={ classNames( "nfd-card__content", className ) }>
		{ children }
	</Component>
);
...
const Footer = ( { as: Component = "div", children, className = "", ...props } ) => (
	<Component { ...props } className={ classNames( "nfd-card__footer", className ) }>
		{ children }
	</Component>
);
