	...
	return (
		<fieldset
			...
			className={ classNames(
				"nfd-checkbox-group",
				disabled && "nfd-checkbox-group--disabled",
				className,
			) }
		>
			<Label as="legend" className="nfd-checkbox-group__label" label={ label } />
			{ description && <div className="nfd-checkbox-group__description">{ description }</div> }
			<div className="nfd-checkbox-group__options">
