...
const classNameMap = {
	variant: {
		"default": "",
		"inline-block": "nfd-radio-group--inline-block",
	},
};
	...
	return (
		<fieldset
			...
			className={ classNames(
				"nfd-radio-group",
				disabled && "nfd-radio-group--disabled",
				classNameMap.variant[ variant ],
				className,
			) }
		>
			{ label && <Label as="legend" className="nfd-radio-group__label" label={ label } /> }
			{ description && <div className="nfd-radio-group__description">{ description }</div> }
			<div className="nfd-radio-group__options">
