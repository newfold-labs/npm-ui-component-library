...
export const Variants = ( args ) => (
	<div className="nfd-flex nfd-items-end nfd-gap-2">
...
export const States = ( args ) => (
	<div className="nfd-flex nfd-items-end nfd-gap-2">
		...
		<StoryComponent disabled={ true } className="nfd-pointer-events-none">Disabled & without pointer-events</StoryComponent>
	</div>
);
States.parameters = {
	controls: { disable: true },
