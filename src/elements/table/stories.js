...
TableHead.args = {
	children:
	<>
		<Table.Head className="nfd-bg-amber-200">
			<Table.Row>
				<Table.Header>Header 1</Table.Header>
				<Table.Header>Header 2</Table.Header>
				<Table.Header>Header 3</Table.Header>
...
TableRow.args = {
	...
	<>
		...
		<Table.Body>
			<Table.Row className="nfd-bg-amber-200">
				<Table.Cell>Cell 1</Table.Cell>
				<Table.Cell>Cell 2</Table.Cell>
				<Table.Cell>Cell 3</Table.Cell>
			</Table.Row>
...
TableHeader.args = {
	...
	<>
		<Table.Head>
			<Table.Row>
				<Table.Header className="nfd-bg-amber-200">Header 1</Table.Header>
				<Table.Header>Header 2</Table.Header>
				<Table.Header>Header 3</Table.Header>
			</Table.Row>
		</Table.Head>
...
TableBody.args = {
	...
	<>
		...
		<Table.Body className="nfd-bg-amber-200">
			<Table.Row>
				<Table.Cell>Cell 1</Table.Cell>
				<Table.Cell>Cell 2</Table.Cell>
				<Table.Cell>Cell 3</Table.Cell>
...
TableCell.args = {
	...
	<>
		...
		<Table.Body>
			<Table.Row>
				<Table.Cell className="nfd-bg-amber-200">Cell 1</Table.Cell>
				<Table.Cell>Cell 2</Table.Cell>
				<Table.Cell>Cell 3</Table.Cell>
			</Table.Row>
			<Table.Row>
