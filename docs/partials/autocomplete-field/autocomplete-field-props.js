const autocompleteFieldProps = {
    ...
    children: {
        type: 'node',
        description: 'Pass `AutocompleteField.Option` components as children',
    },
    selectedLabel: {
        type: 'string',
    ...
    description: {
        type: 'node',
        description: 'Content to be displayed below the input.',
    },
    onChange: {
        type: 'function',
...
export default autocompleteFieldProps;
